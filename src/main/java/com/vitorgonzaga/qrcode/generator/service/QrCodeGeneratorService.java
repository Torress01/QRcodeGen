package com.vitorgonzaga.qrcode.generator.service;
...
import com.vitorgonzaga.qrcode.generator.ports.StoragePort;
...
public class QrCodeGeneratorService {
    ...
    public QrcodeGenerateResponse generateAndUploadQrCode(String text) throws WriterException, IOException {
        ...
        String url = storage.uploadFile(pngQrCodeData, UUID.randomUUID()
                .toString(), "image/png");
